...
- Полная выгрузка из одной чистой копии публичного GitHub намеренно невозможна: приватные исследования не публикуются. Перед экспортом их нужно восстановить в личный проект из закрытой резервной копии. Экспортёр проверяет комплектность до создания новой папки и не оставляет частичный пакет.
